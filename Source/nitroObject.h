...
//#include "nitroTimeStamp.h"
//#include "nitroEventObject.h"
//#include "nitroMetaDataDictionary.h"
...
/** \class Object
 * \brief Base class for most nitro classes.
 *
 * Object is the second-highest level base class for most nitro objects.
 * It extends the base object functionality of LightObject by
 * implementing callbacks (via object/observer), debug flags/methods,
 * and modification time tracking. Most NITRO classes should be a subclas
