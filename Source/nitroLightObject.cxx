...
/*=========================================================================
  ...
  =========================================================================*/
#include "nitroLightObject.h"
#include "nitroObjectFactory.h"
#include "nitroFastMutexLock.h"
...
namespace nitro
{
  ...
  {
    Pointer smartPtr;
    LightObject *rawPtr = ::nitro::ObjectFactory<LightObject>::Create();
    if(rawPtr == NULL)
      {
...
/**
 * Delete a nitro object. This method should always be used to delete an object
...
/**
 * This function will be common to all nitro objects.  It just calls the
 * header/self/trailer virtual print methods, which can be overriden by
 * subclasses (any nitro object).
 */
  void
  LightObject
...
/**
 * This method is called when nitroExceptionMacro executes. It allows
 ...
 */
  ...
  ::~LightObject()
  {
    ...
    if(m_ReferenceCount > 0 && !std::uncaught_exception())
      ...
      // issue a warning.
      // nitroExceptionMacro(<< "Trying to delete object with non-zero reference count.");
      nitroWarningMacro("Trying to delete object with non-zero reference count.");
      }
  }
 ...
 */
  void
  LightObject
  ::PrintTrailer(std::ostream& nitroNotUsed(os)) const
  {
  }
