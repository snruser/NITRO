...
#include "nitroObjectFactoryBase.h"
//#include "nitroDynamicLoader.h"
//#include "nitroDirectory.h"
//#include "nitroVersion.h"
#include <stdlib.h>
#include <ctype.h>
#include <algorithm>
#include <map>
...
//    {
//    LoadPath = getenv("NITRO_AUTOLOAD_PATH");
//    }
//  else
//    {
//    return;
...
//        {
//        /**
//         * Look for the symbol nitroLoad in the library
//         */
//        NITRO_LOAD_FUNCTION loadfunction
//          = (NITRO_LOAD_FUNCTION)DynamicLoader::GetSymbolAddress(lib, "nitroLoad");
//        /**
...
//          // contain the nitroLoad symbol. Unfortuantely, it seems that
