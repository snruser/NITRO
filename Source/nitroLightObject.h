...
/*=========================================================================
  ...
  =========================================================================*/
#ifndef __nitroLightObject_h
#define __nitroLightObject_h

#include "nitroSmartPointer.h"
...
/** \class LightObject
 * \brief Light weight base class for most nitro classes.
 *
 * LightObject is the highest level base class for most nitro objects. It
 ...
 * does.) All NITRO objects should be a subclass of LightObject or Object
 ...
 */
  class NITROCommon_EXPORT LightObject
  {
  public:
    ...
    /** Delete an nitro object.  This method should always be used to delete an
